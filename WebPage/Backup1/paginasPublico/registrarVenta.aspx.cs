...
namespace WebApplication1.paginasPublico
{
    public partial class registrarVenta : System.Web.UI.Page
    {
        ...
        proyectoTableAdapters.tablaObjetoTableAdapter obj = new WebApplication1.proyectoTableAdapters.tablaObjetoTableAdapter();
        proyectoTableAdapters.ventaTableAdapter venta = new WebApplication1.proyectoTableAdapters.ventaTableAdapter();
        proyectoTableAdapters.detalleventaTableAdapter detalleventa = new WebApplication1.proyectoTableAdapters.detalleventaTableAdapter();
        proyectoTableAdapters.usuarioTableAdapter usuar = new WebApplication1.proyectoTableAdapters.usuarioTableAdapter();
