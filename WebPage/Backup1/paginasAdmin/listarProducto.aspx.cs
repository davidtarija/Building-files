...
namespace WebApplication1
{
    ...
    {
        proyectoTableAdapters.repuesto rep = new WebApplication1.proyectoTableAdapters.repuesto();
        int b = 0; int c = 0; int index = 0;
        proyectoTableAdapters.repuesto1TableAdapter rep1 = new WebApplication1.proyectoTableAdapters.repuesto1TableAdapter();
        proyectoTableAdapters.repuesto2TableAdapter rep2 = new WebApplication1.proyectoTableAdapters.repuesto2TableAdapter();
        proyectoTableAdapters.repuesto3TableAdapter rep3 = new WebApplication1.proyectoTableAdapters.repuesto3TableAdapter();
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            {
                Label4.Text = "COMPLETE CORRECTAMENTE LOS DATOS";
            }
        }
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtURL.Text = urlimage;
            imgRepuesto.ImageUrl = txtURL.Text;
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (RadioButtonList1.Items[2].Selected) 
            {
                try
                {
                    GridView1.DataSource = rep.seleccionarPrecio(Convert.ToDecimal(txtParam.Text));
                }
                catch
                {
                    Label1.Text = "INGRESE UN VALOR PARA EL PRECIO";
                }
            }
