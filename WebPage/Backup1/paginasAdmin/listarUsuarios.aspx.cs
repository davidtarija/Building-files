...
namespace WebApplication1.paginasAdmin
{
    ...
    {
        proyectoTableAdapters.personaTableAdapter persona = new WebApplication1.proyectoTableAdapters.personaTableAdapter();
        proyectoTableAdapters.personalTableAdapter personal = new WebApplication1.proyectoTableAdapters.personalTableAdapter();
