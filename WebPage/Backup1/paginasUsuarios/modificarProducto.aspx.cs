...
namespace WebApplication1.paginasUsuarios
{
    ...
    {
        proyectoTableAdapters.repuesto2TableAdapter repTodosProd = new WebApplication1.proyectoTableAdapters.repuesto2TableAdapter();
        proyectoTableAdapters.repuesto3TableAdapter repModificar = new WebApplication1.proyectoTableAdapters.repuesto3TableAdapter();
